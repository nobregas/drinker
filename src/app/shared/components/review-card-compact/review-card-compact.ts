...
@Component({
  selector: 'app-review-card-compact',
  standalone: true,
  imports: [CommonModule, FontAwesomeModule, RatingComponent],
  templateUrl: './review-card-compact.component.html',
  styleUrls: ['./review-card-compact.component.scss']
})
export class ReviewCardCompactComponent {
